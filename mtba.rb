class Subway
    ...
    def stops_between_stations(start_line, start_station, end_line, end_station)
       ...
       start_station=red.stations.index{|station|station.name==start_station}
       end_station=red.stations.index{|station|station.name==end_station}
         
        if start_line == end_line
            total=(start_station- end_station).abs
                puts "total stop:#{total}"
                return total
        else 
            puts ""
